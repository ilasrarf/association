...
<html>
  ...
  <body style="background-color: gray ">
      ...
      <div class="container px-4 px-lg-5">
        ...
        <div style="justify-content: center" class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ms-0 my-2 my-lg-0 ml-lg-auto align-items-start align-items-lg-center">
            <li class="nav-item">
              <a class="nav-link" href="#Politique de confidentialité">Politique de confidentialité</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#Politique des cookies">Politique des cookies</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#Conditions d'utilisation">Conditions d'utilisation</a>
            </li>
          </ul>
    ...
    <!-- About-->
    <div style="height: 150px " id="Politique de confidentialité"></div>
      <div class="container px-4 px-lg-5" >
        <div class="row gx-4 gx-lg-5 justify-content-center">
          <div class="col-lg-9 " >
            <h2 class="text-white mt-0 text-center" >Politique de confidentialité</h2>
...
Si vous avez des questions ou des préoccupations concernant notre politique de confidentialité, vous pouvez nous contacter à l'adresse suivante : privacy@assosiation.com. Nous pouvons choisir de changer ou de modifier notre politique de confidentialité ; dans ce cas, nous afficherons les modifications de notre politique de confidentialité sur le site, et elles prendront effet à la date d'affichage. Si vous êtes préoccupé par la manière dont vos informations personnelles sont utilisées, veuillez visiter souvent notre site pour cette annonce et d'autres annonces et mises à jour importantes.<br>
        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
        <div class="col-lg-9 " >
            <h2 class="text-white mt-0 text-center" >Politique des cookies</h2>
            <hr class="divider divider-danger" />
            <p class="text-white-75 mb-4 fs-5" >
      ...
      <div class="container px-4 px-lg-5" >
        <div class="row gx-4 gx-lg-5 justify-content-center">
        <div class="col-lg-9 " >
            <h2 class="text-white mt-0 text-center" id="Conditions d'utilisation">Conditions d'utilisation</h2>
            <hr class="divider divider-danger" />
            <p class="text-white-75 mb-4 fs-5" > 
...
1. Acceptation des conditions de service<br>
...
4. Utilisation du site ; risque de perte<br>
...
9. Avis de non-responsabilité<br>
...
10. Limitation de la responsabilité<br>
...
12. Réclamations en cas de violation<br>
...
15. Règlement des différends<br>
